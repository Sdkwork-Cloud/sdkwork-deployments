//! Generated API assembly bootstrap for sdkwork-deployments.
...
pub fn assemble_api_router() -> ApiAssembly {
    ...
    router = router.merge(sdkwork_routes_deploy_app_api::gateway_mount(api));
    router = router.merge(sdkwork_routes_deploy_backend_api::gateway_mount(api));
    ApiAssembly { router }
}
