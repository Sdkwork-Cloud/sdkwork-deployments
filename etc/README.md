...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-deployments` |
| `runtimeCode` | `deploy` |
| Config root | `/etc/sdkwork/deploy/` |
| Runtime TOML | `/etc/sdkwork/deploy/config.toml` |
| Secrets | `/etc/sdkwork/deploy/secrets/` |
| Override | `SDKWORK_DEPLOY_CONFIG_FILE` |
