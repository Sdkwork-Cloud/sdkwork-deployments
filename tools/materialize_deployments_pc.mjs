...
const packages = [
  ...
  ["console-core", "app-console", "console-core", { "@sdkwork/deployments-app-sdk": "workspace:*", "@sdkwork/drive-app-sdk": "workspace:*", "@sdkwork/deployments-pc-commons": "workspace:*", "@sdkwork/sdk-common": "workspace:*", react: "catalog:" }, "sdkwork-deployments-app-sdk"],
  ...
  ["console-publishing", "app-console", "publishing", { "@sdkwork/deployments-pc-commons": "workspace:*" }, null, [["artifacts", "Artifacts", "Drive-backed application packages", "deploy.artifacts.read"], ["releases", "Releases", "Immutable release versions", "deploy.releases.read"], ["deployments", "Deployments", "Rollout history and rollback", "deploy.deployments.read"]]],
  ...
  ["admin-core", "backend-admin", "admin-core", { "@sdkwork/deployments-backend-sdk": "workspace:*", "@sdkwork/deployments-pc-commons": "workspace:*", "@sdkwork/sdk-common": "workspace:*", react: "catalog:" }, "sdkwork-deployments-backend-sdk"],
...
for (const [id, surface, capability, dependencies, sdk, entries] of packages) {
  ...
  writeJson(resolve(directory, "package.json"), { name: `@sdkwork/deployments-pc-${id}`, version: "0.1.0", private: true, type: "module", main: "./src/index.ts", exports: packageExports, dependencies, sdkwork: { applicationCode: "deployments", architecture: "pc-react", capability, surface, managedBy: "tools/materialize_deployments_pc.mjs" } });
