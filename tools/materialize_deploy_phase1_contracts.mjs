...
const surfaces = [
  {
    ...
    routeManifestPath:
      "sdks/_route-manifests/app-api/sdkwork-router-deploy-app-api.route-manifest.json",
    crateDir: "crates/sdkwork-router-deploy-app-api",
    manifestFn: "app_route_manifest",
    packageName: "sdkwork-router-deploy-app-api",
    surface: "app-api",
  ...
  },
  {
    ...
    routeManifestPath:
      "sdks/_route-manifests/backend-api/sdkwork-router-deploy-backend-api.route-manifest.json",
    crateDir: "crates/sdkwork-router-deploy-backend-api",
    manifestFn: "backend_route_manifest",
    packageName: "sdkwork-router-deploy-backend-api",
    surface: "backend-api",
