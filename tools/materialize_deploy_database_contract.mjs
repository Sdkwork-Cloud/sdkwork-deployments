...
const baselinePath = path.join(
  root,
  'database/ddl/baseline/postgres/0001_deploy_legacy_baseline.sql',
);
...
const prefixRegistry = {
  ...
  prefixes: [{ prefix: 'deploy_', owner: 'deploy-platform', domain: 'deploy' }],
};
...
process.stdout.write(`materialized ${tableNames.length} tables into deploy database contract\n`);
