...
export interface UploadSessionCompleteParams {
  idempotencyKey: string;
}

export interface UploadSessionCancelParams {
  idempotencyKey: string;
}
...
/** 创建 Drive-backed 包上传会话 */
  async create(body: CreateDeployUploadSessionRequest, params: UploadSessionCreateParams, requestOptions?: ApiRequestOptions): Promise<DeployUploadSessionResponse> {
...
/** 完成上传会话 */
  async complete(uploadSessionId: string, body: CompleteDeployUploadSessionRequest, params: UploadSessionCompleteParams, requestOptions?: ApiRequestOptions): Promise<DeployUploadSessionResponse> {
    const requestHeaders = buildRequestHeaders(
      {
        'Idempotency-Key': { value: params.idempotencyKey, style: 'simple', explode: false },
      },
...
/** 取消上传会话 */
  async cancel(uploadSessionId: string, params: UploadSessionCancelParams, requestOptions?: ApiRequestOptions): Promise<DeployUploadSessionResponse> {
    const requestHeaders = buildRequestHeaders(
      {
        'Idempotency-Key': { value: params.idempotencyKey, style: 'simple', explode: false },
      },
