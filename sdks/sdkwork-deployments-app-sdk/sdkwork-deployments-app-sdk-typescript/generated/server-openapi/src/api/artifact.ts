...
/** Register a Drive-backed deployment artifact */
  async create(body: CreateArtifactRequest, params: ArtifactCreateParams, requestOptions?: ApiRequestOptions): Promise<ArtifactResponse> {
...
export function createArtifactApi(client: HttpClient): ArtifactApi {
  return new ArtifactApi(client);
}
