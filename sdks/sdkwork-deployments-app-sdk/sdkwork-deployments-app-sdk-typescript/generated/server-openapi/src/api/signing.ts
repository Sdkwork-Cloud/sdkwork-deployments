...
import type { CreateSigningIdentityRequest, PageInfo, SigningIdentityResponse } from '../types';


export interface SigningSigningIdentitiesListParams {
  page?: number;
  pageSize?: number;
}

export interface SigningSigningIdentitiesCreateParams {
  idempotencyKey: string;
}

export class SigningSigningIdentitiesApi {
...
/** List tenant signing identities */
  async list(params?: SigningSigningIdentitiesListParams, requestOptions?: ApiRequestOptions): Promise<{ items: SigningIdentityResponse[]; pageInfo: PageInfo; }> {
...
/** Create a signing identity (secret reference only) */
  async create(body: CreateSigningIdentityRequest, params: SigningSigningIdentitiesCreateParams, requestOptions?: ApiRequestOptions): Promise<SigningIdentityResponse> {
...
export function createSigningApi(client: HttpClient): SigningApi {
  return new SigningApi(client);
}
