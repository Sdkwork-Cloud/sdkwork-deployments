...
import type { AppDatabaseMigrationResponse, AppDatabaseProfileResponse, CreateAppDatabaseMigrationRequest, CreateAppDatabaseProfileRequest, PageInfo, UpdateAppDatabaseProfileRequest } from '../types';


export interface AppDatabaseAppDatabaseMigrationsListParams {
  page?: number;
  pageSize?: number;
}

export class AppDatabaseAppDatabaseMigrationsApi {
...
/** List versioned migration definitions of a database profile */
  async list(appId: string, profileId: string, params?: AppDatabaseAppDatabaseMigrationsListParams, requestOptions?: ApiRequestOptions): Promise<{ items: AppDatabaseMigrationResponse[]; pageInfo: PageInfo; }> {
...
export interface AppDatabaseAppDatabaseProfilesListParams {
  page?: number;
  pageSize?: number;
}

export class AppDatabaseAppDatabaseProfilesApi {
  private client: HttpClient;
...
/** List the database structure contracts of an app */
  async list(appId: string, params?: AppDatabaseAppDatabaseProfilesListParams, requestOptions?: ApiRequestOptions): Promise<{ items: AppDatabaseProfileResponse[]; pageInfo: PageInfo; }> {
    const query = buildQueryString([
      { name: 'page', value: params?.page, style: 'form', explode: true, allowReserved: false },
      { name: 'page_size', value: params?.pageSize, style: 'form', explode: true, allowReserved: false },
    ]);
...
export function createAppDatabaseApi(client: HttpClient): AppDatabaseApi {
  return new AppDatabaseApi(client);
}
