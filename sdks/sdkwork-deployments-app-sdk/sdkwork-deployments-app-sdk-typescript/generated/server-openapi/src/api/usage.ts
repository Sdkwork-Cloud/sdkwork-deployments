...
import type { PageInfo, UsageEventResponse } from '../types';


export interface UsageUsageEventsListParams {
  page?: number;
  pageSize?: number;
}

export class UsageUsageEventsApi {
...
/** List tenant usage metering events */
  async list(params?: UsageUsageEventsListParams, requestOptions?: ApiRequestOptions): Promise<{ items: UsageEventResponse[]; pageInfo: PageInfo; }> {
