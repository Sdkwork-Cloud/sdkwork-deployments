...
/** 注册服务器 */
  async create(body: CreateServerRequest, requestOptions?: ApiRequestOptions): Promise<ServerResponse> {
    return this.client.request<ServerResponse>(backendApiPath(`/servers`), { signal: requestOptions?.signal, timeout: requestOptions?.timeout, method: 'POST' as any, body, contentType: 'application/json' });
  }
}
