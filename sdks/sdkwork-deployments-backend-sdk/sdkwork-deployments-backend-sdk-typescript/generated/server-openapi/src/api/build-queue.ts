...
import type { BuildQueueItemResponse, PageInfo } from '../types';


export interface BuildQueueListParams {
  page?: number;
  pageSize?: number;
}

export class BuildQueueApi {
...
/** List queued builds waiting for or claimed by runners */
  async list(params?: BuildQueueListParams, requestOptions?: ApiRequestOptions): Promise<{ items: BuildQueueItemResponse[]; pageInfo: PageInfo; }> {
...
export function createBuildQueueApi(client: HttpClient): BuildQueueApi {
  return new BuildQueueApi(client);
}
