...
/** List ingested Git webhook events */
  async list(params?: SourceEventsListParams, requestOptions?: ApiRequestOptions): Promise<{ items: SourceEventResponse[]; pageInfo: PageInfo; }> {
...
export function createSourceEventsApi(client: HttpClient): SourceEventsApi {
  return new SourceEventsApi(client);
}
