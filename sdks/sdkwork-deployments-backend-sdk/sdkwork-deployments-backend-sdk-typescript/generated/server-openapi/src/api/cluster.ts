...
import type { CreateNodeClusterRequest, NodeClusterResponse, PageInfo, UpdateNodeClusterRequest } from '../types';
...
/** 获取节点集群列表 */
  async list(params?: ClusterListParams, requestOptions?: ApiRequestOptions): Promise<{ items: NodeClusterResponse[]; pageInfo: PageInfo; }> {
...
/** 创建节点集群 */
  async create(body: CreateNodeClusterRequest, params: ClusterCreateParams, requestOptions?: ApiRequestOptions): Promise<NodeClusterResponse> {
