...
/** 注册服务器 */
  async create(body: CreateServerRequest): Promise<ServerResponse> {
    return this.client.post<ServerResponse>(backendApiPath(`/servers`), body, undefined, undefined, 'application/json');
  }
}
