...
| --- | --- | --- |
| `sdkwork-deployments-app-sdk` | `openapi/deploy-app-api.openapi.json` | `sdk-manifest.json`, `specs/component.spec.json` |
| `sdkwork-deployments-backend-sdk` | `openapi/deploy-backend-api.openapi.json` | `sdk-manifest.json`, `specs/component.spec.json` |
