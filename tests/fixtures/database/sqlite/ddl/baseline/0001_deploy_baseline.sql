...
-- test fixture source: historical SQLite deploy baseline
...
-- folded historical migration: 0001_deploy_upload_session_ref.up.sql
...
-- folded historical migration: 0002_deploy_certificate_idempotency_key.up.sql
...
-- folded historical migration: 0003_deploy_artifact_release.up.sql
